...
<main>
    ...
    <section class="slider-area">
        <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
            ...
            <!-- single slider item start -->
            <div class="hero-single-slide hero-overlay">
                <div class="hero-slider-item bg-img" data-bg="assets/img/slider/banner2.webp">
                    <div class="container">
                        <div class="row">
            ...
            <div class="row row-20 mtn-20">
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="assets/img/slider/banner3.jpg" width="300px" alt="product banner">
                        </a>
                ...
                <div class="col-sm-6">
                    <figure class="banner-statistics mt-20">
                        <a href="#">
                            <img src="assets/img/slider/banner3.jpg" alt="product banner" width="300px">
                        </a>
                    ...
                    <div class="product-banner-carousel slick-row-10">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/product/AF1.jpg" alt="product banner">
                                </a>
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/product/AF12.jpg" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/product/AF13.jpg" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                        ...
                        <div class="banner-slide-item">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="assets/img/product/yz2700.jpg" alt="product banner">
                                </a>
                                <div class="banner-content banner-content_style2">
                    ...
                    <div class="testimonial-content-wrapper">
                        <div class="testimonial-content-carousel">
                            <div class="testimonial-content">
                                <p> Chúng tôi mua sắm từ chính cảm xúc và câu chuyện mà thương hiệu mang lại. Đó không chỉ là một trang web giày,
